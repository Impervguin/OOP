...
QT_MOC_LITERAL(5, 39, 22), // "DoneButtonActionSignal"
QT_MOC_LITERAL(6, 62, 20), // "DoneButtonActionSlot"
QT_MOC_LITERAL(7, 83, 17) // "pressedButtonSlot"

    },
    "LiftButton\0PressedSignal\0\0size_t\0floor\0"
    "DoneButtonActionSignal\0DoneButtonActionSlot\0"
    "pressedButtonSlot"
};
...
void LiftButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->PressedSignal((*reinterpret_cast< size_t(*)>(_a[1]))); break;
        case 1: _t->DoneButtonActionSignal(); break;
        case 2: _t->DoneButtonActionSlot(); break;
        case 3: _t->pressedButtonSlot(); break;
        default: ;
        }
        ...
        {
            using _t = void (LiftButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LiftButton::DoneButtonActionSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LiftButton::PressedSignal(size_t _t1)
{
...
// SIGNAL 1
void LiftButton::DoneButtonActionSignal()
{
